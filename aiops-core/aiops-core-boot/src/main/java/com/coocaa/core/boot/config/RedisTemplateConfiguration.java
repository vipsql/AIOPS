...
import com.coocaa.core.boot.redis.RedisKeySerializer;
...
//	}
    ...
    private Map<String, RedisCacheConfiguration> getRedisCacheConfigurationMap() {
        ...
        redisCacheConfigurationMap.put(RedisConstant.AUTH_TOKEN.PREFIX, this.getRedisCacheConfigurationWithTtl(3));
