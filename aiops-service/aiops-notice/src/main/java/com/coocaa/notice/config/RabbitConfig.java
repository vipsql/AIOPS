package com.coocaa.notice.config;
...
public class RabbitConfig {
    ...
    public RabbitTemplate rabbitTemplate() {
        ...
        rabbitTemplate.setConfirmCallback((correlationData, ack, cause) -> {
            ...
            if (ack) {
                ...
                getIMailServeiceInstance().updateStatus(Long.valueOf(msgId), Constant.MsgLogStatus.DELIVER_SUCCESS);
            } else {
                getIMailServeiceInstance().updateStatus(Long.valueOf(msgId), Constant.MsgLogStatus.DELIVER_FAIL);
    ...
    public IMailService getIMailServeiceInstance() {
        if (msgLogService != null) {
            return msgLogService;
        }
        msgLogService = SpringUtil.getBean("MailService");
        return msgLogService;
    }
}
